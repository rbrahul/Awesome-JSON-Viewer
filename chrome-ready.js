...
exec(
  "cp " +
    ...
    __dirname +
    "/build/static/js/contentScript.js",
...
exec("mkdir " + __dirname + "/build/static/css/themes", function (
  error,
  stdout,
  stderr
) {
...
exec("rm -f " + __dirname + "/build/static/js/main*.js.map ", function (
  error,
  stdout,
  stderr
) {
...
exec("rm -f " + __dirname + "/build/static/css/main*.css.map ", function (
  error,
  stdout,
  stderr
) {
...
exec(
  "mv " + __dirname + "/build/css/*.css " + __dirname + "/build/static/css",
  function (error, stdout, stderr) {
    if (error !== null) {
      console.log("exec error: " + error);
    } else {
...
exec(
  "mv " +
    __dirname +
    "/build/css/themes/*.css " +
    __dirname +
    "/build/static/css/themes",
  function (error, stdout, stderr) {
    if (error !== null) {
      console.log("exec error: " + error);
    } else {
      console.log("All files in css/themes folder moved to static/css/themes");
      exec("rm -rf " + __dirname + "/build/css", function (
        error,
        stdout,
        stderr
      ) {
...
exec(
  "mv " + __dirname + "/build/js/*.js " + __dirname + "/build/static/js",
  function (error, stdout, stderr) {
    if (error !== null) {
      console.log("exec error: " + error);
    } else {
      console.log("All files in js folder moved to static/js");
      exec("rm -rf " + __dirname + "/build/js", function (
        error,
        stdout,
        stderr
      ) {
